...
class FortuneCookie implements ISurprise {
	...
	public void enjoy() {
		...
		System.out.println("\"" + getChosenQuote() + "\"");
	}

	@Override
	public String toString() {
		return "[FortuneCookie] message = " + this.chosenQuote;
	}

	public static FortuneCookie generate() {
		int randomQuoteIndex = FortuneCookie.randomGenerator.nextInt(FortuneCookie.quotes.length);
